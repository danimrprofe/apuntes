# 3. Animación personalizada de cámara
...
```
En resumen, lo que haremos será tomar "fotos" de la escena desde diferentes ángulos en momentos determinados, y Blender calculará los movimientos a realizar entre los dos puntos.
```
