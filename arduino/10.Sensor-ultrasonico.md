...
El módulo HC-SR04 del sensor ultrasónico proporciona la función sin contacto de la medida entre 2 cm y 400 cm, la precisión que varía puede alcanzar los 3 mm. 

El principio básico del trabajo es el siguiente:

Utilizando el disparador IO para una señal de nivel alto de al menos 10us,

El Módulo envía automáticamente ocho 40 kHz y detecta si hay una señal de retorno. Esta señal de retorno dependerá de la distancia recorrida y, por tanto, de la distancia.
...
void loop() {
   a=sr04.Distance(); //Devuelve la distancia en Cm.
   Serial.print(a);
   Serial.println("cm");
