...
La común conexión es el segundo pin, que también es el más largo de las cuatro patas y se conectarán a la **tierra** (GND).
...
![](media/media/image62.jpeg" id="image62">
...
```c linenums="1" title="pruebaLEDRGB1.ino"
// Define pines
#define BLUE 3
#define GREEN 5
#define RED 6
...
```c  linenums="1" title="pruebaLEDRGB2.ino"
// Define pines
#define BLUE 3
#define GREEN 5
#define RED 6
